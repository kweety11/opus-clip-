...
| الوضع | للمين | الإعداد |
|---|---|---|
| ☁️ **حساب Film-trend** | جمهورك — شهر مجاني ثم 10$/شهر، من غير أي مفاتيح | يتفعل بنشر `backend/worker.js` (شرح كامل في `backend/README.md`) |
| 🔑 **مفتاح خاص** | المحترفين — 11 مزود بمفاتيحهم | شغال فورًا |
| 🆓 **Gemini المجاني** | تجربة ببلاش | ضمن وضع المفتاح الخاص — مفتاح مجاني من aistudio.google.com |
